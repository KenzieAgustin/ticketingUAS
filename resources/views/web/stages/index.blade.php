...
<div class="page-header">
    ...
    <a href="{{ route('web.stages.create') }}" class="btn btn-primary">
        <i class="bi bi-plus-lg"></i> Tambah Stage
    </a>
</div>
    ...
    <div class="card-body">
        ...
        <table class="table table-hover align-middle">
            <thead class="table-dark">
                <tr><th>#</th><th>Nama Stage</th><th>Lokasi</th><th>Kapasitas</th><th>Aksi</th></tr>
            </thead>
            <tbody>
