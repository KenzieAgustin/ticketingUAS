    ...
    <div class="card-body">
        <form action="{{ route('web.event-media.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="url" class="form-control @error('url') is-invalid @enderror" value="{{ old('url') }}" placeholder="https://...">
