...
class GateSeeder extends Seeder
{
    public function run(): void
    {
        $gates = [
            ...
            ['code' => 'GATE-KONSER-FESTIVAL', 'name' => 'Gate Konser Festival', 'type' => 'concert', 'stage_id' => null, 'description' => 'Gate untuk masuk ke area konser festival', 'status' => 'active'],
            ['code' => 'GATE-KONSER-VIP', 'name' => 'Gate Konser VIP', 'type' => 'concert', 'stage_id' => null, 'description' => 'Gate VIP untuk masuk ke area konser utama', 'status' => 'active'],
            ['code' => 'GATE-KONSER-VVIP', 'name' => 'Gate Konser VVIP', 'type' => 'concert', 'stage_id' => null, 'description' => 'Gate VVIP untuk masuk ke area konser utama', 'status' => 'active'],

            // Gate area pameran (stage_id diisi setelah seeder Stage dijalankan)
            ['code' => 'GATE-HALL-A', 'name' => 'Gate Hall A', 'type' => 'exhibition', 'stage_id' => null, 'description' => 'Gate untuk masuk ke area pameran 1', 'status' => 'active'],
            ['code' => 'GATE-HALL-B', 'name' => 'Gate Hall B', 'type' => 'exhibition', 'stage_id' => null, 'description' => 'Gate untuk masuk ke area pameran 2', 'status' => 'active'],
